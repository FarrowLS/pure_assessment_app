...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assessment.itemsneededtopass'
        db.add_column(u'assessment_assessment', 'itemsneededtopass',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Assessment.itemsneededtopass'
        db.delete_column(u'assessment_assessment', 'itemsneededtopass')
