...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assessment_assessment', 'status',
                      self.gf('model_utils.fields.StatusField')(default='not-started', max_length=100, no_check_for_status=True),
                      keep_default=False)

        # Adding field 'Assessment.status_changed'
        db.add_column(u'assessment_assessment', 'status_changed',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Assessment.status_changed'
        db.delete_column(u'assessment_assessment', 'status_changed')
    ...
    models = {
        u'assessment.assessment': {
            ...
            'testee': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'auth.group': {
