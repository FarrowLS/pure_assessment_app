...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TesteeAssessment'
        db.create_table(u'assessment_testeeassessment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('assessment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assessment.Assessment'])),
            ('testee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('model_utils.fields.StatusField')(default='not-started', max_length=100, no_check_for_status=True)),
        ))
        db.send_create_signal(u'assessment', ['TesteeAssessment'])


    def backwards(self, orm):
        # Deleting model 'TesteeAssessment'
        db.delete_table(u'assessment_testeeassessment')
