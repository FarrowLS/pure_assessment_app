...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TesteeResponse.status'
        db.delete_column(u'assessment_testeeresponse', 'status')

        # Adding field 'TesteeResponse.option'
        db.add_column(u'assessment_testeeresponse', 'option',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['itembank.Option'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TesteeResponse.status'
        db.add_column(u'assessment_testeeresponse', 'status',
                      self.gf('model_utils.fields.StatusField')(default='started', max_length=100, no_check_for_status=True),
                      keep_default=False)

        # Deleting field 'TesteeResponse.option'
        db.delete_column(u'assessment_testeeresponse', 'option_id')
    ...
    models = {
        ...
        u'assessment.testeeresponse': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['itembank.Option']", 'blank': 'True'}),
