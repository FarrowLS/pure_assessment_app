...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TesteeResponse.option'
        db.alter_column(u'assessment_testeeresponse', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['itembank.Option'], null=True))

    def backwards(self, orm):

        # Changing field 'TesteeResponse.option'
        db.alter_column(u'assessment_testeeresponse', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['itembank.Option']))
    ...
    models = {
        ...
        u'assessment.testeeresponse': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['itembank.Option']", 'null': 'True', 'blank': 'True'}),
