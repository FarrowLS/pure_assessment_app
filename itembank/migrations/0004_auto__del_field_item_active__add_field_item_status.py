...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'itembank_item', 'active')

        # Adding field 'Item.status'
        db.add_column(u'itembank_item', 'status',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'itembank_item', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Item.status'
        db.delete_column(u'itembank_item', 'status')
